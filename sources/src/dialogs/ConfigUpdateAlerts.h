...
#ifndef WEBMONX_CONFIGUPDATEALERTS_H
#define WEBMONX_CONFIGUPDATEALERTS_H

#include "ui_ConfigUpdateAlerts.h"
#include "gui/include.h"

class ConfigUpdateAlerts : public QWidget, private Ui::ConfigUpdateAlerts
{
  Q_OBJECT
  
  public:
    ConfigUpdateAlerts(CoreGUI* core, QWidget* parent);
    void save();
  
  private slots:
    void updatePopupEnabled();
...
#endif // WEBMONX_CONFIGUPDATEALERTS_H
