...
#ifndef WEBMONX_CONFIGVISUAL_H
#define WEBMONX_CONFIGVISUAL_H

#include "ui_ConfigVisual.h"
#include "gui/include.h"

class ConfigVisual : public QWidget, private Ui::ConfigVisual
{
  Q_OBJECT
  
  public:
    ConfigVisual(CoreGUI* core, QWidget* parent);
    void save();
